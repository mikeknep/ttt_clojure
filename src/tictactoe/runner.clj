...
(defn -main []
  (play (create-board (prompt (get-board-length))) (create-player (prompt (get-player-type)) (prompt (get-player-token))) (create-player (prompt (get-player-type)) (prompt (get-player-token)))))
